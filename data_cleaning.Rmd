...
data2$host_response_time[is.na(data2$host_response_time)] <- 0
data2$host_response_rate[is.na(data2$host_response_rate)] <- 0
data2$host_acceptance_rate[is.na(data2$host_acceptance_rate)] <- 0
data2$host_listings_count[is.na(data2$host_listings_count)] <- 0
data2$bathrooms_text[is.na(data2$bathrooms_text)] <- 0
