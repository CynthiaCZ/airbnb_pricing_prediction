...
data2$host_is_superhost <- ifelse(data$host_is_superhost == "t", 1, 0)
data2$host_has_profile_pic <- ifelse(data$host_has_profile_pic == "t", 1, 0)
data2$host_identity_verified <- ifelse(data$host_identity_verified == "t", 1, 0)
data2$instant_bookable <- ifelse(data$instant_bookable == "t", 1, 0)
